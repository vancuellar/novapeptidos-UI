const page = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        'Aceptamos tarjeta (crédito o débito: Visa, Mastercard y American Express), transferencia SPEI, efectivo en OXXO y criptomonedas. No manejamos pagos contra entrega.',
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          a: 'Con tarjeta, la verificación es casi inmediata y algo salió mal; escríbenos. Con SPEI, el pedido queda en pendiente hasta que el banco refleja la transferencia: en horario bancario suele ser cuestión de minutos, pero de noche, en fin de semana o en festivo puede pasar al siguiente día hábil. Mandarnos el comprobante lo resuelve al momento. Con OXXO, el pedido se confirma solo en cuanto la tienda nos avisa de tu pago; puede tardar unas horas. Con criptomoneda, el pedido se confirma solo en cuanto la red acredita el pago; normalmente son minutos.',
        },
      ],
    },
    {
